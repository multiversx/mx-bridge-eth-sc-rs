...
//     blockchain.register_contract(MULTISIG_CODE_PATH, multi_transfer_esdt::ContractBuilder);
...
//             .nonce(1)
//             .esdt_balance(WEGLD_TOKEN_ID, 100_000_000_000u64)
//             .esdt_balance(ETH_TOKEN_ID, 200_000_000_000u64)
...
//         .esdt_balance(WEGLD_TOKEN_ID, token_amount);
// }
