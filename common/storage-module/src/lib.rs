...
pub trait CommonStorageModule {
    ...
    fn get_bridge_proxy_address(&self) -> SingleValueMapper<ManagedAddress, ManagedAddress> {
        SingleValueMapper::<_, _, ManagedAddress>::new_from_address(
            self.blockchain().get_owner_address(),
    ...
    fn get_esdt_safe_address(&self) -> SingleValueMapper<ManagedAddress, ManagedAddress> {
        SingleValueMapper::<_, _, ManagedAddress>::new_from_address(
            self.blockchain().get_owner_address(),
    ...
    fn get_multi_transfer_address(&self) -> SingleValueMapper<ManagedAddress, ManagedAddress> {
        SingleValueMapper::<_, _, ManagedAddress>::new_from_address(
            self.blockchain().get_owner_address(),
    ...
    fn get_fee_estimator_address(&self) -> SingleValueMapper<ManagedAddress, ManagedAddress> {
        SingleValueMapper::<_, _, ManagedAddress>::new_from_address(
            self.blockchain().get_owner_address(),
