...
pub const BRIDGE_PROXY_CONTRACT_ADDRESS_STORAGE_KEY: &[u8] = b"bridgeProxyContractAddress";
pub const BRIDGED_TOKENS_WRAPPER_ADDRESS_STORAGE_KEY: &[u8] = b"bridgedTokensWrapperAddress";
pub const ESDT_SAFE_CONTRACT_ADDRESS_STORAGE_KEY: &[u8] = b"esdtSafeContractAddress";
pub const MULTI_TRNASFER_CONTRACT_ADDRESS_STORAGE_KEY: &[u8] = b"multiTransferContractAddress";
pub const FEE_ESTIMATOR_CONTRACT_ADDRESS_STORAGE_KEY: &[u8] = b"feeEstimatorContractAddress";
